...
var result3 = buildName("Bob", "Adams"); // 성공
console.log(result3);
...
function buildName2(firstName2, lastName2) {
    if (lastName2)
        return firstName2 + " " + lastName2;
    else
        return firstName2;
}
var result4 = buildName2("Bob"); // 지금은 바르게 작동하는것처럼 보임
...
function buildName3(firstName3, lastName3) {
    if (lastName3 === void 0) { lastName3 = "Smith"; }
    return firstName3 + " " + lastName3;
}
var result7 = buildName3("Bob"); // 올바르게 동작, "Bob Smith"로 반환되어서 출력된다.
console.log(result7);
var result8 = buildName3("Bob", undefined); // 동작 -> Bob Smith로 출력
console.log(result8);
...
// 그래서
function buildName4(firstName4, lastName4) {
}
// 과
function buildName5(firstName5, lastName5) {
    if (lastName5 === void 0) { lastName5 = "Smith"; }
}
